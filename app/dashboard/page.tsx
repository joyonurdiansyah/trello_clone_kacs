    ...
    return (
        ...
        <main className="container mx-auto px-4 py-6 sm:py-8">
            ...
            <p className="text-gray-600 mb-4">
                Heres whats happening with your boards and tasks today.
            </p>
            ...
            <div className="flex flex-col gap-2 mb-6">
                {/* View Toggle */}
                <div className="flex items-center space-x-1 bg-white border rounded-lg p-1 w-fit">
                <Button
